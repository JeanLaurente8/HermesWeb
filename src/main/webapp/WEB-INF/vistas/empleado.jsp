...
<!DOCTYPE html><html lang="es"><head>
        ...
        <script>
            ...
            // Lógica AJAX para Consulta de DNI a la API (peruapi.com)
                            ...
                            fetch('${pageContext.request.contextPath}/EmpleadoServlet?accion=consultarDni&dni=' + dniValue, {
                                method: 'POST'
                                    ...
                                    .then(data => {
                                        ...
                                        if (apePat)
                                            document.getElementById('apePatInput').value = apePat;
                                        if (apeMat)
                                            document.getElementById('apeMatInput').value = apeMat;
